...
export type WindowRecord = { id: string; name?: string; state: 'open'|'closed'; source: any; bridge: boolean; security: any; queue: EventQueue; win?: RuntimeWindow; closedAt?: number; expiresAt?: number };
...
export class WindowRegistry {
  ...
  open(html: string, opts: { name?: string; replace?: boolean; options?: any; source?: any; bridge?: boolean; security?: any } = {}) {
    if (opts.name) {
